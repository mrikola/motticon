...
function StaffView() {
  ...
  const [resultsMissing, setResultsMissing] = useState(players.filter(player => player.submitted == false).length);
    ...
    <Container className="mt-3 my-md-4">
     ...
     <Row>
        ...
        <Col xs={12}>
          ...
          <p className="lead">{resultsMissing}/{totalMatches} matches remaining</p>
        </Col>
