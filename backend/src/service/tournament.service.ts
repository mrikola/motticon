...
import { DraftPodGenerationStrategy, PreferentialPodAssignments, PreferencesByPlayer } from '../dto/tournaments.dto';
import { randomize } from '../util/random';
import { makeArray } from '../util/array';
import { WILD_CARD_IDENTIFIER, popularPriorityPodAssignemnts } from './popularPriorityPodAssigments';
...
export class TournamentService {
    ...
    async getCurrentDraft(tournamentId: number): Promise<Draft> {
        return await this.appDataSource
            ...
            .leftJoinAndSelect("cards.pickedCards", "pickedCards")
