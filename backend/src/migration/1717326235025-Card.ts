...
export class Card1717326235025 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "card" ADD "manaCost" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "card" ADD "oracleText" character varying NOT NULL`);
