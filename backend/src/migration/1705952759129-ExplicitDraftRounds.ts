...
export class ExplicitDraftRounds1705952759129 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "draft" ADD "firstRound" smallint NOT NULL DEFAULT '1'`);
        await queryRunner.query(`ALTER TABLE "draft" ADD "lastRound" smallint NOT NULL DEFAULT '3'`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "draft" ADD "rounds" smallint NOT NULL`);
    }
